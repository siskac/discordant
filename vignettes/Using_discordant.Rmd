...
Given the small quantity of features in the 
example data sets provided by `r Biocpkg("discordant")`, we cannot provide
an example of successfull subsampling here.
